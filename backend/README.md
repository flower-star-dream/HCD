...
HCD是一个基于Spring Cloud的微服务架构后端项目，采用领域驱动设计(DDD)思想，实现了用户管理、座位管理、票务管理、订单和系统管理等核心业务模块。
...
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/hcd_xxx?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8
    username: root
