            ...
            <div class="horizontal-layout">
                ...
                <div class="avatar-section">
                    ...
                    <div class="nickname-display">
                        ...
                        <div class="nickname-value">{{ userInfo.nickname || '未设置昵称' }}</div>
                    </div>
                </div>
                
                <!-- 表单部分 - 在右侧 -->
                <div class="form-section">
                    <el-form :model="userInfo" label-width="120px" size="large" class="form-container" :rules="rules" ref="formRef">
                        ...
                        <el-form-item label="用户手机号" prop="phone">
                            <el-input v-model="userInfo.phone" placeholder="请输入手机号" type="tel"></el-input>
                        </el-form-item>
                        <el-form-item label="所属站点" prop="affiliatedSite">
                            <el-input v-model="userInfo.affiliatedSite" placeholder="请输入所属站点"></el-input>
                        </el-form-item>
                        <el-form-item label="权限等级" prop="permissionLevel">
                            <el-input v-model="userInfo.permissionLevel" disabled></el-input>
                        </el-form-item>
...
import { useUserStore, ossUrl } from '@/stores'
...
const uploadSuccess = (res: any) => {
    userInfo.value = { ...userInfo.value, avatar: res.data }
...
// 组件挂载时执行
onMounted(() => {
    // 确保originalUserInfo有初始值
    originalUserInfo.value = { ...userInfo.value }
})
</script>

<style scoped lang="scss">
@use './User-info-view.scss';
</style>
